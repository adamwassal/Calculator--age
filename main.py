...
def checkError():
    ...
    if (dayField.get() == "" or monthField.get() == "" or yearField.get() == "" or givenDayField.get() == "" or givenMonthField.get() == "" or givenYearField.get() == ""):
        messagebox.showerror("Input Error", "Please enter the birth date and given date")
...
if __name__ == "__main__":
    ...
    resultantage = Button(gui, text = "Resultant Age", fg = "white",bg = "brown", command = calculateAge)
    ...
    resultdate.grid(row = 4, column=2)
